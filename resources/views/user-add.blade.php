              ...
              <form class="form-horizontal">
                <div class="card-body">
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="nis" class="form-control" id="inputNis" placeholder="NIS">
                    </div>
                  </div>
                  <div class="form-group row">
                    <label for="inputNam" class="col-sm-2 col-form-label">Nama</label>
                    <div class="col-sm-10">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="kelas" class="form-control" id="inputKelas" placeholder="Kelas">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->

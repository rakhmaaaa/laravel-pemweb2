            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="card">
                            <div class="buttons">
                                <button type="button" class="btn btn-primary" onclick="location.href='{{ url('alternatif') }}'">
                                    Kembali
                                </button>
                            </div>
                        </div>
                        ...
                        @foreach ($getdata as $q)
                            <form action="/alternatif/{id}/edit-alternatif-proses" method="post" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label for="alternatif">Gender</label>
                                    <input type="text" required="required" class="form-control" name="jenis_kelamin"
                                        value="{{ $p->jenis_kelamin}}">
                                </div>
                                <div class="form-group">
                                    <label for="alternatif">Agama</label>
                                    <input type="text" required="required" class="form-control" name="agama"
                                        value="{{ $p->agama}}">
                                </div>
                                <div class="form-group">
                                  <label for="kelas">Kelas Sekarang</label>
                                  <label>"{{ $q->kelas->nama_kelas }}"</label>
                                  <label for="ubah">Ubah Kelas Ke </label>
                                  <select required="required" class="form-control" name="kelas_id">

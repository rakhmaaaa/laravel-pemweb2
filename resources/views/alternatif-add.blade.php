            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('alternatif-prosestambah') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="row form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <a class="text-dark">Gender<a class='red'> *</a></a>
                                        <input class="form-control input-bb" type="text" name="jenis_kelamin" id="jenis_kelamin"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control input-bb" type="text" name="agama" id="agama"
                                            value="{{ old('agama') }}" />
                                        <span style="color:red">
                                            @error('agama')
                                                {{ $message }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control input-bb" type="text" name="kelas_id" id="kelas_id"
                                            value="{{ old('kelas_id') }}" />
                                        <span style="color:red">
                                            @error('kelas_id')
                                                {{ $message }}
